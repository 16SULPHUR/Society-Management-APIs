...
export type AddonData<T> = TechFieldsAppData & {
	data: T;
};
...
export type ConversionOptions<T extends ValueOf<typeof ConversionType>> = T extends ConversionType.VIDEO ? BaseConversionOption<T> : BaseConversionOption<T> & {
	saveInGroup?: boolean;
};
 ...
 */
export declare class RestClientError extends UploadcareError {
...
export declare function conversionInfo(options: ConversionInfoOptions, userSettings: ApiRequestSettings): Promise<ConversionInfoResponse>;
