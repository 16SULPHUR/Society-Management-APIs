import nodeFetch, { Headers as Headers$1, Request as Request$1 } from 'node-fetch';
...
const createSignature = (...args) => {
    return import('./createSignature.node.7dca34c7.mjs').then((m) => m.createSignature(...args));
};
...
class UploadcareAuthSchema {
    ...
    constructor(options) {
        ...
        if (md5Loader) {
            ...
            this._md5Loader = import('./md5.node.98e30147.mjs').then((m) => m.md5);
        }
    }
    async md5(input) {
